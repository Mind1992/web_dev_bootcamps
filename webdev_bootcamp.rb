...
def main_menu
  loop do
    ...
    puts "6: add a technology to bootcamp"
    puts "7: list all bootcamps by technology"
    puts "8: list all bootcamps by length"
    puts "9: exit"
    input = gets.chomp
    case input
      ...
      when '6' then add_technology_to_bootcamp
      when '7' then find_by_technology
      when '8' then find_by_length
      when '9' then exit
      else
